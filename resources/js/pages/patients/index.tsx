                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4">
                    <div className="w-full max-w-2xl overflow-hidden rounded-2xl border border-[#e4ddd4] bg-white shadow-xl">
                        ...
                        <form onSubmit={createPatient} className="grid gap-4 p-5 md:grid-cols-2">
                            ...
                            <PasswordField label="Password" type="password" value={createForm.password} error={page.props.errors?.password} onChange={(value) => setCreateForm((current) => ({ ...current, password: value }))} />
                            <PasswordField label="Konfirmasi Password" type="password" value={createForm.password_confirmation} error={page.props.errors?.password_confirmation} onChange={(value) => setCreateForm((current) => ({ ...current, password_confirmation: value }))} />
