...
function DefaultDashboard({ modules }: { modules: Module[] }) {
    return (
        <AppLayout>
            ...
            <div className="flex h-full items-center justify-center gap-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-center text-[12px] font-medium text-red-600">
                <p>Terjadi kesalahan saat memuat data dashboard.</p>
                <p>Silakan coba lagi nanti atau hubungi admin jika masalah berlanjut.</p>
            </div>
